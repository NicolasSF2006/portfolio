  ...
  return (
    ...
    */
    <a
      ...
      className="fixed right-6 bottom-[120px] z-[999] flex h-[64px] w-[64px] items-center justify-center rounded-full bg-[#35C7B0] text-white shadow-lg transition-transform duration-300 hover:scale-110 max-[426px]:right-5 max-[426px]:bottom-[96px] max-[426px]:h-[52px] max-[426px]:w-[52px]"
    >
